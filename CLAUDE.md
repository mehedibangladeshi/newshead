...
```
<task_type>(<location/feature/module name>): <task description in ~60 characters>
```
...
- Never add `Co-Authored-By: Claude`, `Generated with Claude`, or any similar AI-attribution line to commits.
